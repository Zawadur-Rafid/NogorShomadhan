...
type ActivityFilter = 'All' | AdminActivityCategory;
  ...
  const openActivity = useCallback(
    (activity: AdminActivity) => {
      switch (activity.entityType) {
        case 'complaint':
          router.push(`/(admin)/complaints/${activity.entityId}` as never);
          return;
        case 'duplicate':
          router.push(`/(admin)/duplicates/${activity.entityId}` as never);
          return;
        case 'forum_post':
          router.push(
            `/(admin)/forum?postId=${activity.entityId}` as never,
          );
          return;
        case 'account':
          router.push('/(admin)/accounts/registered' as never);
          return;
        default:
      ...
      <FlatList
            ...
            <View style={styles.hero}>
              ...
              <View style={styles.heroCopy}>
                ...
                <Text style={styles.subtitle}>
                  Account approvals, complaint verifications, duplicate
                  decisions, forum moderation, and settings changes recorded by
                  the Administration.
                </Text>
              </View>
          ...
          <View style={styles.emptyState}>
            {loading ? (
              <>
                ...
                <Text style={styles.emptyText}>Building the admin operations timeline.</Text>
              </>
            ) : error ? (
              <>
              ...
              <>
                ...
                <Text style={styles.emptyText}>
                  {activities.length === 0
                    ? 'Account, complaint, duplicate, forum, and settings actions from the Administration will appear here.'
        ...
        ListFooterComponent={
          hasMore ? (
            ...
            <Text style={styles.endText}>End of the admin activity log.</Text>
          ) : null
        }
      />
    </View>
