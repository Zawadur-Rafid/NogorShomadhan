            ...
            <View style={styles.profileMenu}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  router.push(
                    '/authority/activity-log' as never,
                  );
                }}
              >
                <Ionicons
        ...
        >
          ...
          <View style={styles.welcomeRow}>
            ...
            >
              ...
              <Text
                style={
                  styles.allComplaintsButtonText
                }
              >
                All Complaints
              </Text>
          ...
          <View style={styles.toolsSection}>
            ...
            <View
              style={[
                styles.toolsGrid,
                wide &&
                  styles.toolsGridWide,
              ]}
            >
              <TouchableOpacity
                style={[
                  styles.toolCard,
                  styles.analyticsToolCard,
                ]}
                onPress={() =>
                  router.navigate(
                    '/authority/analytics' as never,
                  )
                }
              >
                <View
              ...
              <TouchableOpacity
                style={[
                  styles.toolCard,
                  styles.feedbackToolCard,
                ]}
                onPress={() =>
                  router.navigate(
                    '/authority/feedback-center' as never,
                  )
                }
              >
                <View
              ...
              <TouchableOpacity
                style={[
                  styles.toolCard,
                  styles.forumToolCard,
                ]}
                onPress={() =>
                  router.navigate(
                    '/authority/forum' as never,
                  )
                }
              >
                <View
...
const styles = StyleSheet.create({
  ...
  profileMenu: {
    ...
    borderColor: '#E5E7EB',
    boxShadow:
      '0 10px 28px rgba(35, 67, 93, 0.16)',
    zIndex: 30,
  },
