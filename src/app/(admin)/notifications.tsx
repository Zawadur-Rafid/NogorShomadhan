...
const styles = StyleSheet.create({
  ...
  errorText: { color: "#B42318", fontSize: 12, marginTop: 2 },
  retryButton: {
    paddingHorizontal: 14,
    paddingVertical: 8,
    borderRadius: 16,
  ...
  retryText: { color: "#B42318", fontSize: 12, fontWeight: "800" },
  stateCard: {
    alignItems: "center",
    justifyContent: "center",
    gap: 10,
  ...
  stateText: { color: "#667085", fontSize: 13, lineHeight: 19, textAlign: "center" },
  emptyIcon: {
    width: 56,
    height: 56,
    alignItems: "center",
  ...
  notificationTitle: { flex: 1, color: "#344054", fontSize: 13, fontWeight: "700" },
  notificationTitleUnread: { color: "#1F2937", fontWeight: "800" },
  notificationTime: { color: "#98A2B3", fontSize: 10 },
  notificationMessage: { color: "#667085", fontSize: 12, lineHeight: 18, marginTop: 4 },
});
