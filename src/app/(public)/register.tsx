...
export default function Register() {
  ...
  const [errors, setErrors] = useState<
    Partial<Record<FieldName | "terms", string>>
  >({});
      ...
      try {
        ...
        if (error) {
          ...
          if (error.message.toLowerCase().includes("unique")) {
            setErrors({
              terms: "An account with this email or username already exists.",
            });
          } else {
            ...
            <View>
              ...
              >
                ...
                <Text style={styles.termsText}>
                  ...
                  <Text style={styles.termsLink}>Privacy Policy</Text> of Nogor
                  Shomadhan.
                </Text>
              </Pressable>
              {errors.terms && (
